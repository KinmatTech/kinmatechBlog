...
if($query):
  echo "<script>alert('comment successfully submitted. Comment will be display after admin review ');</script>";
...
<head>
    <title>Kinmat Technologies Limited | News Details</title>
